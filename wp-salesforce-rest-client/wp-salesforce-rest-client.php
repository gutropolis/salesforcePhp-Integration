...
if (!class_exists('WPSalesforceRestClient')) {
    class WPSalesforceRestClient {
        ...
        private $headers;
        public $instance_url="https://<instance>.salesforce.com";
        public $token_url = "https://login.salesforce.com/services/oauth2/token";
        public $restPublicClientToken;
        public $access_token;
        ...
        function __construct() {
            ...
            $this->instance_url = str_replace("<instance>", $this->properties['salesforce']['instance'], $this->instance_url);
         ...
         //   $this->restPublicClientToken = $this->restClientToken->getTokenResponse();
        }


        function postLeadData($post_data){
            $apiurl = $this->instance_url."/services/data/v37.0/sobjects/Lead/";
            ...
            $headers  = str_replace("[token]", $this->access_token, $headers );
        ...
        function updateLeadData($post_data,$lead_id){
            $apiurl = $this->instance_url."/services/data/v37.0/sobjects/Lead/".$lead_id;
            echo $apiurl;
            $lead_id='';
            $body_json = json_encode($post_data);
...
if (!class_exists('WPSalesforceRestClientToken')) {
    class WPSalesforceRestClientToken {
        private $response;
        private $properties;
        private $url = "https://login.salesforce.com/services/oauth2/token";
        private $body;
